...
type ProcessorState =
  ...
  | { status: 'done'; downloadUrl: string; downloadName: string; summary: PiiSummary; noMatches: boolean }
...
export function usePdfProcessor(): {
  ...
  const processFile = useCallback(async (file: File) => {
    // TODO: Premium — wysłać do /api/pdf/redact zamiast przetwarzać lokalnie
